...
function updateStats() {
  ...
  $('pageInfo').textContent = `${Math.max(1, Math.ceil(editorEl.scrollHeight / 960))} page${Math.ceil(editorEl.scrollHeight / 960) === 1 ? '' : 's'}`;
}
...
$('templatesBtn').addEventListener('click', () => {
  ...
  $('panelContent').innerHTML = `
    <button class="template-choice" data-template="letter"><strong>Professional Letter</strong><span>Date · recipient · subject · body · signature</span></button>
    <button class="template-choice" data-template="memo"><strong>Business Memo</strong><span>To · From · Date · Subject · message</span></button>
    <button class="template-choice" data-template="blank"><strong>Blank Page</strong><span>Start with a clean document</span></button>`;
  openRightPanel();
